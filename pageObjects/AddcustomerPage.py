...
class AddCustomer:
    ...
    Customer_info = "//*[@id='customer-info']/div[1]/div[1]"
    clickOnSearchIcon = "/html/body/div[3]/div[1]/form[1]/section/div/div/div/div[1]/div/div[1]/div[2]/i"
    ...
    def ClickOnCustomerInfo(self):
        self.driver.find_element_by_xpath(self.Customer_info).click()


    def clickSearchIcon(self):
        self.driver.find_element_by_id(self.clickOnSearchIcon).click()
